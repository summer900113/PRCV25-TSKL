...
class unire(nn.Module):
    ...
    def forward(self, image, text, softlabel_image_features=None, softlabel_text_features=None, epoch=None, idx=None, softlabel_text_features_r=None):
        ...
        return cross_modal_loss, uni_modal_loss, contrastive_loss, (loss_i2t.item(), loss_t2i.item(), loss_i2i.item(), loss_t2t.item())
